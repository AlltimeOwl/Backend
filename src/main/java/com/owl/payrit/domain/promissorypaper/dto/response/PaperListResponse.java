...
public record PaperListResponse(
    ...
    public PaperListResponse(PromissoryPaper promissoryPaper, PaperRole paperRole,
        ...
        this(
                ...
                paperRole,
                promissoryPaper.getPaperFormInfo().getTransactionDate(),
                promissoryPaper.getPaperFormInfo().getRepaymentStartDate(),
                promissoryPaper.getPaperFormInfo().getRepaymentEndDate(),
                promissoryPaper.getPaperFormInfo().getAmount(),
